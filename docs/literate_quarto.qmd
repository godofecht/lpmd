---
title: "Literate Python Markdown with Quarto"
format: html
jupyter: python3
---

# Literate Python Markdown (.qmd) Demo

This demonstrates **Literate Python Markdown** using Quarto - a professional publishing system with code execution.
...
```{python}
#| label: compression
#| depends: compressor,frequency_control
# Apply compression
with torch.no_grad():
...
```{python}
#| label: summary
#| depends: compression,intermediates
